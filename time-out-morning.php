			...
			<div class="page-single">
				<div class="container">
					...
					<div class="">
						<center>
						<div>
							<h4 class="timein">Tiempo de salida Matutina</h4>
						</div>
						<div class="col-md-4">
							<div class="form-group">
							<form v-on:submit.prevent="TimeOutMorning">
								<input type="text" required="true"  v-model="time_out_morning" class="form-control" id="employee-id" placeholder="Identificacion de Empleados" autofocus="true">
							</form>
							</div>						
						</div>
					</center>
