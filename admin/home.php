              ...
              <div class="col-12" id="printDataHolder">
                ...
                <div class="card">
                  <div class="card-header py-3">
                    <h3 class="card-title">Nómina desde <b><?php echo date('M d, Y', strtotime($from)) ?>&nbsp(<?php echo date('D', strtotime($from)) ?>) </b>To <b><?php echo date('M d, Y', strtotime($to)) ?>&nbsp(<?php echo date('D', strtotime($to)) ?>)</b></h3>
                  </div>
                  <div class="card-body">
