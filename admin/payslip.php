              ...
              <div class="col-12" id="printDataHolder">
                ...
                <div class="table-responsive push">
                  <table class="table table-bordered table-hover">
                    <tr>
                      <th colspan="8">Recibo de pago de Precious Bros Construction #<?php echo $number ?></th>
                ...
                <p class="text-muted text-center">Recibo de pago generado el <?php echo date("m/d/Y") ?> <?php echo date("H:i A") ?> by <?php echo $firstname ?> <?php echo $lastname ?></p>
              </div> 
